...
public class AnnotationsBefore_AfterClass
{
WebDriver driver;
...
public void trelloLogin() throws InterruptedException
{
    ...
    driver.findElement(By.id("username")).sendKeys("gaurav182048@gmail.com");
    driver.findElement(By.id("login-submit")).submit();
    driver.findElement(By.id("password")).sendKeys("gita@2018");
    driver.findElement(By.id("login-submit")).submit();
    Thread.sleep(2000);
}
}
